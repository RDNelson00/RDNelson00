...
My most recent project is a Strava data extraction, processing, and visualization pipeline that I built with Python and Power BI to analyze my running data. It has allowed me to analyze recent & historical trends of my running performance
